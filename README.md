...
| service_mgr       | string   |   upstart, systemd, none                                                                                 |       autodetect: ansible_service_mgr                                                                                                                      | Use this to override the service_mgr, e.g. to set it to systemd or to 'none' if you do not want to enable the service at all                                                               |
